...
async def continues(message: types.Message):
    block1 = types.KeyboardButton("1 БЛОК – ПІДТВЕРДЖЕННЯ ПРАВА ВЛАНОСТІ НА МАЙНО", callback_data="1 БЛОК – ПІДТВЕРДЖЕННЯ ПРАВА ВЛАНОСТІ НА МАЙНО")
    block2 = types.KeyboardButton("2 БЛОК – ФІКСАЦІЯ ДСНС", callback_data="2 БЛОК – ФІКСАЦІЯ ДСНС")
    block3 = types.KeyboardButton("3 БЛОК – ФІКСАЦІЯ СІЛЬСЬКОЮ/СЕЛИЩНОЮ МІСЬКОЮ РАДОЮ, У РАЗІ ЇХ ВІДСУТНОСТІ ВІЙСЬКОВОЮ АДМІНІСТРАЦІЄЮ АБО ВІЙСЬКОВО-ЦИВІЛЬНОЮ АДМІНІСТРАЦІЄЮ", callback_data="3 БЛОК – ФІКСАЦІЯ СІЛЬСЬКОЮ/СЕЛИЩНОЮ МІСЬКОЮ РАДОЮ, У РАЗІ ЇХ ВІДСУТНОСТІ ВІЙСЬКОВОЮ АДМІНІСТРАЦІЄЮ АБО ВІЙСЬКОВО-ЦИВІЛЬНОЮ АДМІНІСТРАЦІЄЮ")
    block4 = types.KeyboardButton("4 БЛОК – ФІКСАЦІЯ НПУ", callback_data="4 БЛОК – ФІКСАЦІЯ НПУ")
    block5 = types.KeyboardButton("5 БЛОК – ФІКСАЦІЯ ДЕРЖАВНОЮ ЕКОЛОГІЧНОЮ ІНСПЕКЦІЄЮ", callback_data="5 БЛОК – ФІКСАЦІЯ ДЕРЖАВНОЮ ЕКОЛОГІЧНОЮ ІНСПЕКЦІЄЮ")
    block6 = types.KeyboardButton("6 БЛОК – САМОСТІЙНА ФІКСАЦІЯ", callback_data="6 БЛОК – САМОСТІЙНА ФІКСАЦІЯ")
    block7 = types.KeyboardButton("7 БЛОК – ЗБІР ПОЯСНЕНЬ СВІДКІВ", callback_data="7 БЛОК – ЗБІР ПОЯСНЕНЬ СВІДКІВ")
    block8 = types.KeyboardButton("8 БЛОК – ЗБІР МАТЕРІАЛІВ ЗІ ЗМІ", callback_data="8 БЛОК – ЗБІР МАТЕРІАЛІВ ЗІ ЗМІ")
    block9 = types.KeyboardButton("9 БЛОК – ЗБІР  ЧЕКІВ НА ПОШКОДЖЕНЕ/ЗРУЙНОВАНЕ МАЙНО", callback_data="9 БЛОК – ЗБІР  ЧЕКІВ НА ПОШКОДЖЕНЕ/ЗРУЙНОВАНЕ МАЙНО")
    block10 = types.KeyboardButton("10 БЛОК – ЗБІР ІНФОРМАЦІЇ ПРО ПІДКЛЮЧЕННЯ КОМУНАЛЬНИХ ПОСЛУГ", callback_data="10 БЛОК – ЗБІР ІНФОРМАЦІЇ ПРО ПІДКЛЮЧЕННЯ КОМУНАЛЬНИХ ПОСЛУГ")
    block11 = types.KeyboardButton("11 БЛОК – ЗБЕРЕЖЕННЯ ЗІБРАНИХ МАТЕРІАЛІВ", callback_data="11 БЛОК – ЗБЕРЕЖЕННЯ ЗІБРАНИХ МАТЕРІАЛІВ")
    block12 = types.KeyboardButton("12 БЛОК – ЗВЕРНЕННЯ ДО НПУ ІЗ ЗАЯВОЮ", callback_data="12 БЛОК – ЗВЕРНЕННЯ ДО НПУ ІЗ ЗАЯВОЮ")
    block13 = types.KeyboardButton("13 БЛОК – ПОДАННЯ ОНЛАЙН ЗАЯВОК", callback_data="13 БЛОК – ПОДАННЯ ОНЛАЙН ЗАЯВОК")
...
@dp.message_handler(text="1 БЛОК – ПІДТВЕРДЖЕННЯ ПРАВА ВЛАНОСТІ НА МАЙНО")
async def block1(message: types.Message):
    ...
    await bot.send_message(text="1 БЛОК – ПІДТВЕРДЖЕННЯ ПРАВА ВЛАНОСТІ НА МАЙНО", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest1_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="1 БЛОК – ПІДТВЕРДЖЕННЯ ПРАВА ВЛАНОСТІ НА МАЙНО")
...
@dp.message_handler(text="2 БЛОК – ФІКСАЦІЯ ДСНС")
async def block2(message: types.Message):
    ...
    await bot.send_message(text="2 БЛОК – ФІКСАЦІЯ ДСНС", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest2_1and2(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="2 БЛОК – ФІКСАЦІЯ ДСНС")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="3 БЛОК – ФІКСАЦІЯ СІЛЬСЬКОЮ/СЕЛИЩНОЮ МІСЬКОЮ РАДОЮ, У РАЗІ ЇХ ВІДСУТНОСТІ ВІЙСЬКОВОЮ АДМІНІСТРАЦІЄЮ АБО ВІЙСЬКОВО-ЦИВІЛЬНОЮ АДМІНІСТРАЦІЄЮ")
...
async def quests3_1_2_3(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="3 БЛОК – ФІКСАЦІЯ СІЛЬСЬКОЮ/СЕЛИЩНОЮ МІСЬКОЮ РАДОЮ, У РАЗІ ЇХ ВІДСУТНОСТІ ВІЙСЬКОВОЮ АДМІНІСТРАЦІЄЮ АБО ВІЙСЬКОВО-ЦИВІЛЬНОЮ АДМІНІСТРАЦІЄЮ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="4 БЛОК – ФІКСАЦІЯ НПУ")
async def block4(message: types.Message):
    ...
    await bot.send_message(text="4 БЛОК – ФІКСАЦІЯ НПУ", chat_id=message.from_user.id, reply_markup=mar)


@dp.message_handler(text="Чи можна звернутися до поліції для фіксації?")
async def quest4_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="4 БЛОК – ФІКСАЦІЯ НПУ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
    await bot.send_message(text="Так", chat_id=message.from_user.id, reply_markup=mar)
...
@dp.message_handler(text="5 БЛОК – ФІКСАЦІЯ ДЕРЖАВНОЮ ЕКОЛОГІЧНОЮ ІНСПЕКЦІЄЮ")
async def block5(message: types.Message):
    ...
    await bot.send_message(text="5 БЛОК – ФІКСАЦІЯ ДЕРЖАВНОЮ ЕКОЛОГІЧНОЮ ІНСПЕКЦІЄЮ", chat_id=message.from_user.id, reply_markup=mar)


@dp.message_handler(text="Як зафіксувати завдану шкоду довкіллю?")
async def quest5_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="5 БЛОК – ФІКСАЦІЯ ДЕРЖАВНОЮ ЕКОЛОГІЧНОЮ ІНСПЕКЦІЄЮ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="6 БЛОК – САМОСТІЙНА ФІКСАЦІЯ")
async def block6(message: types.Message):
    ...
    await bot.send_message(text="6 БЛОК – САМОСТІЙНА ФІКСАЦІЯ", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest6_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="6 БЛОК – САМОСТІЙНА ФІКСАЦІЯ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="7 БЛОК – ЗБІР ПОЯСНЕНЬ СВІДКІВ")
async def block7(message: types.Message):
    ...
    back = types.KeyboardButton("Назад🔙", callback_data="back")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    await bot.send_message(text="7 БЛОК – ЗБІР ПОЯСНЕНЬ СВІДКІВ", chat_id=message.from_user.id, reply_markup=mar)


@dp.message_handler(text="Хто має право отримати пояснення у свідків?")
async def quest7_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="7 БЛОК – ЗБІР ПОЯСНЕНЬ СВІДКІВ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="8 БЛОК – ЗБІР МАТЕРІАЛІВ ЗІ ЗМІ")
async def block8(message: types.Message):
    ...
    back = types.KeyboardButton("Назад🔙", callback_data="back")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    await bot.send_message(text="8 БЛОК – ЗБІР МАТЕРІАЛІВ ЗІ ЗМІ", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest8_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="8 БЛОК – ЗБІР МАТЕРІАЛІВ ЗІ ЗМІ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
    await bot.send_message(text="Так", chat_id=message.from_user.id, reply_markup=mar)
...
@dp.message_handler(text="9 БЛОК – ЗБІР  ЧЕКІВ НА ПОШКОДЖЕНЕ/ЗРУЙНОВАНЕ МАЙНО")
...
async def quest9_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="9 БЛОК – ЗБІР  ЧЕКІВ НА ПОШКОДЖЕНЕ/ЗРУЙНОВАНЕ МАЙНО")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="10 БЛОК – ЗБІР ІНФОРМАЦІЇ ПРО ПІДКЛЮЧЕННЯ КОМУНАЛЬНИХ ПОСЛУГ")
async def block10(message: types.Message):
    ...
    await bot.send_message(text="10 БЛОК – ЗБІР ІНФОРМАЦІЇ ПРО ПІДКЛЮЧЕННЯ КОМУНАЛЬНИХ ПОСЛУГ", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest10_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="10 БЛОК – ЗБІР ІНФОРМАЦІЇ ПРО ПІДКЛЮЧЕННЯ КОМУНАЛЬНИХ ПОСЛУГ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="11 БЛОК – ЗБЕРЕЖЕННЯ ЗІБРАНИХ МАТЕРІАЛІВ")
async def block11(message: types.Message):
    ...
    back = types.KeyboardButton("Назад🔙", callback_data="back")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    await bot.send_message(text="11 БЛОК – ЗБЕРЕЖЕННЯ ЗІБРАНИХ МАТЕРІАЛІВ", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest11_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="11 БЛОК – ЗБЕРЕЖЕННЯ ЗІБРАНИХ МАТЕРІАЛІВ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="12 БЛОК – ЗВЕРНЕННЯ ДО НПУ ІЗ ЗАЯВОЮ")
async def block12(message: types.Message):
    ...
    await bot.send_message(text="12 БЛОК – ЗВЕРНЕННЯ ДО НПУ ІЗ ЗАЯВОЮ", chat_id=message.from_user.id, reply_markup=mar)


@dp.message_handler(text="Чому і для чого необхідно звернутися до НП?")
async def quest12_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="12 БЛОК – ЗВЕРНЕННЯ ДО НПУ ІЗ ЗАЯВОЮ")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
...
@dp.message_handler(text="13 БЛОК – ПОДАННЯ ОНЛАЙН ЗАЯВОК")
async def block13(message: types.Message):
    ...
    await bot.send_message(text="13 БЛОК – ПОДАННЯ ОНЛАЙН ЗАЯВОК", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest13_1(message: types.Message):
    back = types.KeyboardButton("Назад🔙", callback_data="13 БЛОК – ПОДАННЯ ОНЛАЙН ЗАЯВОК")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(back)
