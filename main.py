...
async def continues(message: types.Message):
    global mess
    mess = message
    block1 = types.KeyboardButton(texts['block1']['title'])
    block2 = types.KeyboardButton(texts['block2']['title'])
    block3 = types.KeyboardButton(texts['block3']['title'])
    block4 = types.KeyboardButton(texts['block4']['title'])
    block5 = types.KeyboardButton(texts['block5']['title'])
    block6 = types.KeyboardButton(texts['block6']['title'])
    block7 = types.KeyboardButton(texts['block7']['title'])
    block8 = types.KeyboardButton(texts['block8']['title'])
    block9 = types.KeyboardButton(texts['block9']['title'])
    block10 = types.KeyboardButton(texts['block10']['title'])
    block11 = types.KeyboardButton(texts['block11']['title'])
    block12 = types.KeyboardButton(texts['block12']['title'])
    block13 = types.KeyboardButton(texts['block13']['title'])
...
async def block1(message: types.Message=None, callback_data: types.CallbackQuery=None):
    print(message)
    quest1 = types.KeyboardButton(texts['block1']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block1']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block1']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block1']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block1']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block1']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block1']['questions']['question7'])
    quest8 = types.KeyboardButton(texts['block1']['questions']['question8'])
    quest9 = types.KeyboardButton(texts['block1']['questions']['question9'])
...
async def block2(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block2']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block2']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block2']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block2']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block2']['questions']['question5'])
    back = types.KeyboardButton("Назад🔙")
...
async def block3(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block3']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block3']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block3']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block3']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block3']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block3']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block3']['questions']['question7'])
    quest8 = types.KeyboardButton(texts['block3']['questions']['question8'])
    back = types.KeyboardButton("Назад🔙")
...
async def block4(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block4']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block4']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block4']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block4']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block4']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block4']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block4']['questions']['question7'])
    back = types.KeyboardButton("Назад🔙")
...
async def block5(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block5']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block5']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block5']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block5']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block5']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block5']['questions']['question6'])
    back = types.KeyboardButton("Назад🔙")
...
async def block6(message: types.Message=None, callback_data:types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block6']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block6']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block6']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block6']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block6']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block6']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block6']['questions']['question7'])
    quest8 = types.KeyboardButton(texts['block6']['questions']['question8'])
    quest9 = types.KeyboardButton(texts['block6']['questions']['question9'])
    quest10 = types.KeyboardButton(texts['block6']['questions']['question10'])
    quest11 = types.KeyboardButton(texts['block6']['questions']['question11'])
    quest12 = types.KeyboardButton(texts['block6']['questions']['question12'])
    quest13 = types.KeyboardButton(texts['block6']['questions']['question13'])
    quest14 = types.KeyboardButton(texts['block6']['questions']['question14'])
    back = types.KeyboardButton("Назад🔙")
...
async def block7(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block7']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block7']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block7']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block7']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block7']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block7']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block7']['questions']['question7'])
    back = types.KeyboardButton("Назад🔙")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    if message:
        await bot.send_message(text="Оберіть питання для отримання консультації👇", chat_id=message.from_user.id, reply_markup=mar)
...
async def block8(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block8']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block8']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block8']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block8']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block8']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block8']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block8']['questions']['question7'])
    back = types.KeyboardButton("Назад🔙")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    if message:
        await bot.send_message(text="Оберіть питання для отримання консультації👇", chat_id=message.from_user.id, reply_markup=mar)
...
async def block9(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block9']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block9']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block9']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block9']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block9']['questions']['question5'])
    back = types.KeyboardButton("Назад🔙")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, back)
    if message:
        await bot.send_message(text="Оберіть питання для отримання консультації👇", chat_id=message.from_user.id, reply_markup=mar)
...
async def block10(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block10']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block10']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block10']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block10']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block10']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block10']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block10']['questions']['question7'])
    quest8 = types.KeyboardButton(texts['block10']['questions']['question8'])
    quest9 = types.KeyboardButton(texts['block10']['questions']['question9'])
    quest10 = types.KeyboardButton(texts['block10']['questions']['question10'])
    back = types.KeyboardButton("Назад🔙")
    mar = types.ReplyKeyboardMarkup().add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, quest8, quest9, quest10, back)
    if message:
        await bot.send_message(text="Оберіть питання для отримання консультації👇", chat_id=message.from_user.id, reply_markup=mar)
    else:
...
async def block11(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block11']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block11']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block11']['questions']['question3'])
    quest4 = types.KeyboardButton(texts['block11']['questions']['question4'])
    quest5 = types.KeyboardButton(texts['block11']['questions']['question5'])
    quest6 = types.KeyboardButton(texts['block11']['questions']['question6'])
    quest7 = types.KeyboardButton(texts['block11']['questions']['question7'])
    back = types.KeyboardButton("Назад🔙")
    mar = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=1).add(quest1, quest2, quest3, quest4, quest5, quest6, quest7, back)
    if message:
        await bot.send_message(text="Оберіть питання для отримання консультації👇", chat_id=message.from_user.id, reply_markup=mar)
...
async def block12(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block12']['questions']['question1'])
    quest2 = types.KeyboardButton(texts['block12']['questions']['question2'])
    quest3 = types.KeyboardButton(texts['block12']['questions']['question3'])
    back = types.KeyboardButton("Назад🔙")
...
async def block13(message: types.Message=None, callback_data: types.CallbackQuery=None):
    quest1 = types.KeyboardButton(texts['block13']['questions']['question1'])
    back = types.KeyboardButton("Назад🔙")
