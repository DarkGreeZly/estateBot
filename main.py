...
async def quest1_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Підтвердження права власності на майнo")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest2_1and2(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Фіксація ДСНС")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quests3_1_2_3(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Фіксація сільською/селищною міською радою, у разі їх відсутності військовою адміністрацією або військово-цивільною адміністрацією")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest4_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Фіксація НПУ")
    mar = types.InlineKeyboardMarkup().add(back)
    await bot.send_message(text="Так", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest5_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Фіксація державною екологічною інспекцією")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest6_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Самостійна фіксація")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest7_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Збір пояснень свідків")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest8_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Збір матеріалів зі ЗМІ")
    mar = types.InlineKeyboardMarkup().add(back)
    await bot.send_message(text="Так", chat_id=message.from_user.id, reply_markup=mar)
...
async def quest9_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Збір  чеків на пошкоджене/зруйноване майно")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest10_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Збір інформації про підключення комунальних послуг")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest11_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Збереження зібраних матеріалів")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest12_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Звернення до НПУ із заявою")
    mar = types.InlineKeyboardMarkup().add(back)
...
async def quest13_1(message: types.Message):
    back = types.InlineKeyboardButton("Назад🔙", callback_data="Подання онлайн заявок")
    mar = types.InlineKeyboardMarkup().add(back)
